...
/** InfoCard: icon sits BESIDE the title */
const InfoCard = ({ Icon, title, children }) => (
  <div className="p-6 rounded-xl shadow-card hover:shadow-lg transition-shadow bg-surface border border-border">
...
export default function LandingPage({ embedded = false }) {
  ...
  return (
    <div className="min-h-screen font-sans bg-background text-primary-text transition-colors">
      ...
      {/* Hero */}
      <section className="relative text-center py-20 sm:py-32 px-4 overflow-hidden bg-surface/60">
        <div className="absolute top-0 left-0 w-64 h-64 rounded-full opacity-40 -translate-x-16 -translate-y-16 blur-2xl bg-primary/20" />
        <div className="absolute bottom-0 right-0 w-72 h-72 rounded-full opacity-40 translate-x-16 translate-y-16 blur-2xl bg-primary-hover/20" />
        <div className="max-w-4xl mx-auto relative z-10">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 leading-tight tracking-tighter text-primary-text">
          ...
          <p className="text-base sm:text-lg md:text-xl mb-8 sm:mb-10 max-w-3xl mx-auto text-secondary-text">
            Transform college projects into successful startups. Compete, learn,
            and pitch to real investors through PPL – the ultimate startup
            league for students.
          </p>
          <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 justify-center items-stretch sm:items-center">
            <RouterLink
              to={exploreTo}
              className="w-full sm:w-auto px-6 sm:px-8 py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-[1.02] shadow-sm hover:shadow-md inline-flex items-center justify-center gap-2 bg-primary text-white hover:bg-primary-hover"
            >
              <Compass className="h-5 w-5" />
              Explore Competitions
            </RouterLink>
            ...
            {!isAuthenticated && (
              <RouterLink
                to="/roles"
                className="w-full sm:w-auto px-6 sm:px-8 py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-[1.02] shadow-sm hover:shadow-md inline-flex items-center justify-center gap-2 border border-border bg-surface text-primary-text hover:bg-border"
              >
                <Rocket className="h-5 w-5" />
                Get Started
              </RouterLink>
      ...
      <section id="about" className="py-16 sm:py-24 px-4 bg-background">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg mb-10 sm:mb-12 max-w-3xl mx-auto text-secondary-text">
            The{" "}
            <span className="font-bold text-primary">Premier Project League (PPL)</span>{" "}
            is India's first platform connecting students, colleges, and
            investors to turn academic projects into startup opportunities.
          </p>
