    ...
    <SidebarLayout currentPage="competitions" onPageChange={() => {}}>
      <div className="flex-1 overflow-y-auto overflow-x-hidden">
        <div className="p-4 sm:p-6">
          ...
          {/* Summary */}
          <div className="bg-surface rounded-xl p-4 border border-border mb-4 sm:mb-6">
            <div className="flex flex-col sm:flex-row items-start gap-4">
              <div className="w-20 h-20 sm:w-16 sm:h-16 rounded-lg bg-background border border-border flex items-center justify-center overflow-hidden flex-shrink-0">
                {comp.banner_image_url ? (
                  <img src={comp.banner_image_url} alt={comp.title} className="w-full h-full object-cover" />
                ) : (
                ...
                <div className="mt-3 grid grid-cols-1 sm:grid-cols-3 gap-2">
                  ...
                  {"seats_remaining" in comp && (
                    <div className="flex items-center gap-2 px-3 py-2 bg-background rounded-lg border border-border">
                      ...
                      <span className="text-secondary-text text-sm">
                        <strong className="text-primary-text">Seats Left:</strong> {comp.seats_remaining}
                      </span>
                    </div>
                  )}
                </div>
          ...
          {/* Tabs */}
          {/* Mobile: 2-column grid (no horizontal scroll). Desktop: inline row. */}
          <div className="mb-0">
          ...
          {/* Panel */}
          <div className="p-4 sm:p-5 border border-border rounded-b-xl sm:rounded-tr-xl bg-surface space-y-6">
            {/* Overview */}
            {activeTab === "overview" && (
              <>
                {(comp.description_long || comp.overview || comp.description) && (
                  <div>
                    ...
                    <p className="text-secondary-text whitespace-pre-wrap text-sm sm:text-base break-words">
                      {comp.description_long || comp.overview || comp.description}
                    </p>
                  </div>
                )}
